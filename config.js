...
module.exports = {
    ...
    BOTNAME: process.env.BOT_NAME === undefined ? '  ☚⃟፝༄ʙʟᴀᴄᴋ sᴇʀ☚⃟፝࿐  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? '✮⃝🎸ʙʟᴀᴄᴋ sᴇʀ ᴅᴏᴡɴʟᴏᴅɪɴɢ ʏᴏᴜʀ sᴏɴɢ✮⃝🎧' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '✮⃝🎸ʙʟᴀᴄᴋ sᴇʀ ᴜᴘʟᴏᴀᴅɪɴɢ ʏᴏᴜʀ sᴏɴɢ✮⃝🎧' : process.env.SONGU,
    ...
    BOTV2: process.env.BOTV2_NAME === undefined ? 'Bʟᴀᴄᴋ sᴇʀ' : process.env.BOTV2_NAME,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? '☚⃟፝༄Bʟᴀᴄᴋ sᴇʀ☚⃟፝࿐' : process.env.LOGO_NAME,
